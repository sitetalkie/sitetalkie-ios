...
struct VoiceNoteView: View {
    ...
    private var backgroundColor: Color {
        colorScheme == .dark ? Color(red: 0.059, green: 0.059, blue: 0.059).opacity(0.6) : Color.white
    }

    private var borderColor: Color {
        colorScheme == .dark ? Color(red: 0.961, green: 0.620, blue: 0.043).opacity(0.3) : Color(red: 0.961, green: 0.620, blue: 0.043).opacity(0.2)
    }
        ...
        HStack(spacing: 12) {
            Button(action: playback.togglePlayback) {
                Image(systemName: playback.isPlaying ? "pause.fill" : "play.fill")
                    ...
                    .background(Circle().fill(Color(red: 0.961, green: 0.620, blue: 0.043)))
            }
            .buttonStyle(.plain)
