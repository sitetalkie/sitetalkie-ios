...
struct BitChatPaymentChipView: View {
...
#Preview {
    ...
    List {
        HStack {
            BitChatPaymentChipView(paymentType: .cashu(cashuLink))
            BitChatPaymentChipView(paymentType: .lightning(lightningLink))
        }
