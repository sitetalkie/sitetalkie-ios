...
struct FingerprintView: View {
    ...
    private var textColor: Color {
        colorScheme == .dark ? Color(red: 0.961, green: 0.620, blue: 0.043) : Color(red: 0.961, green: 0.620, blue: 0.043)
    }
    
    private var backgroundColor: Color {
        colorScheme == .dark ? Color(red: 0.059, green: 0.059, blue: 0.059) : Color.white
    }
                ...
                HStack {
                    if let icon = encryptionStatus.icon {
                        Image(systemName: icon)
                            ...
                            .foregroundColor(encryptionStatus == .noiseVerified ? Color(red: 0.961, green: 0.620, blue: 0.043) : textColor)
                    }
                ...
                if encryptionStatus == .noiseSecured || encryptionStatus == .noiseVerified {
                    ...
                    VStack(spacing: 12) {
                        Text(isVerified ? Strings.verifiedBadge : Strings.notVerifiedBadge)
                            ...
                            .foregroundColor(isVerified ? Color(red: 0.984, green: 0.749, blue: 0.141) : Color.orange)
                            .frame(maxWidth: .infinity)
