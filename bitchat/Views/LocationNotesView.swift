...
struct LocationNotesView: View {
    ...
    private var backgroundColor: Color { colorScheme == .dark ? Color(red: 0.059, green: 0.059, blue: 0.059) : Color.white }
    private var accentGreen: Color { colorScheme == .dark ? Color(red: 0.961, green: 0.620, blue: 0.043) : Color(red: 0.961, green: 0.620, blue: 0.043) }
