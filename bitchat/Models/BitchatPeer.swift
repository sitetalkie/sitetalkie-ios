...
struct BitchatPeer: Equatable {
    ...
    var rssi: Int?           // Last known BLE RSSI (signal strength)
    var latitude: Double?    // GPS latitude from peer announcement
    var longitude: Double?   // GPS longitude from peer announcement
    var altitude: Double?    // GPS altitude (meters) from peer announcement
