...
final class MessageFormattingEngine {
    ...
    static func formatHeader(
        ...
        if message.sender == "system" {
            ...
            style.font = .bitchatSystem(size: 16, weight: .medium, design: .monospaced)
    ...
    private static func formatSystemMessage(_ message: BitchatMessage, isDark: Bool) -> AttributedString {
        ...
        contentStyle.font = .bitchatSystem(size: 14, design: .monospaced).italic()
        ...
        timestampStyle.font = .bitchatSystem(size: 12, design: .monospaced)
    ...
    private static func formatSenderHeader(
        ...
        senderStyle.font = .bitchatSystem(size: 16, weight: fontWeight, design: .monospaced)
    ...
    private static func formatPlainContent(_ content: String, baseColor: Color, isSelf: Bool) -> AttributedString {
        ...
        style.foregroundColor = baseColor
        style.font = isSelf
            ? .bitchatSystem(size: 16, weight: .bold, design: .monospaced)
            : .bitchatSystem(size: 16, design: .monospaced)
    ...
    private static func formatMatch(_ text: String, type: MatchType, baseColor: Color, isSelf: Bool) -> AttributedString {
        ...
        case .mention:
            ...
            mentionStyle.font = .bitchatSystem(size: 16, weight: .semibold, design: .monospaced)
        ...
        case .url:
            ...
            style.font = .bitchatSystem(size: 16, design: .monospaced)
        ...
        case .cashu:
            style.foregroundColor = Color(red: 0.961, green: 0.620, blue: 0.043)
            style.font = .bitchatSystem(size: 16, weight: .medium, design: .monospaced)
            style.backgroundColor = Color(red: 0.961, green: 0.620, blue: 0.043).opacity(0.1)
    ...
    private static func formatTimestamp(_ timestamp: String) -> AttributedString {
        ...
        style.font = .bitchatSystem(size: 12, design: .monospaced)
