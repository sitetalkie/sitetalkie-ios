...
final class NotificationService {
    ...
    func sendPublicChannelNotification(channelName: String, sender: String, message: String, channelID: String) {
        ...
        let title = "SiteTalkie \(channelName)"
        let body = "\(sender): \(message)"
        let identifier = "public-channel-\(channelID)-\(Date().timeIntervalSince1970)"
        let userInfo: [String: Any] = ["channelID": channelID, "channelName": channelName]
